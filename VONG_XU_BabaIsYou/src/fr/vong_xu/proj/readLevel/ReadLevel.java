...
public class ReadLevel {
	 ...
	 * @return void
	 */
	private void drawBoard(Graphics2D graphics, Board board, List<BiYBlock> win_list, List<BiYBlock> sink_list, List<BiYBlock> defeat_list) {
	...
	private void setAll(ApplicationContext context, Board board) {
		context.renderFrame(graphics -> drawBoard(graphics, board, win_list, sink_list, defeat_list));
